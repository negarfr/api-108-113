...
public void get18 (){
    ...
    // set the expectedData ==> need to
// first inner part hwich is Country
...
// 3rd - Customer class       we create  ArrayList as text asking check class for customers
...
// send the request and get Res

    Response response = given().
            spec(spec).
            headers("Authorization","Bearer"+generateToken()). // we create this in AuthenticationHerOkuApp class
            when().
            get("/{first}/{second}");
